...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 75f09f14-4b77-418e-bc6c-c56432bc3737
```

> `75f09f14-4b77-418e-bc6c-c56432bc3737` is the password of the certificate, you can change it to any password you want.
